function main() {
    ...
    setOvalVertices(gl, n,  0.25, 0.15, -0.3, 0.0); // Define as coordenadas do círculo
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl, n, [1.0, 0.0, 0.8]); 
    ...
    n = 60; // Número de triângulos para formar o círculo
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setOvalVertices(gl, n,  0.15, 0.25, 0.0, 0.3); // Define as coordenadas do círculo
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl, n, [1.0, 0.0, 0.8]); 
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n); // Desenha o círculo
    ...
    n = 60; // Número de triângulos para formar o círculo
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setOvalVertices45(gl, n,  0.25, 0.15, -0.2, 0.2, -45); // Define as coordenadas do círculo
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl, n, [1.0, 0.0, 0.8]); 
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n); // Desenha o círculo
    ...
    //Desenho do miolo da flor
    n = 90; // Número de triângulos para o círculo suave
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setCircleVertices(gl, n, 0.2, 0.0, 0.0); 
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl, n, [1.0, 1.0, 0.0]); // Define a cor amarela para o círculo
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n); // Desenha o círculo
...
function setOvalVertices45(gl, n, radiusX, radiusY, centerX = 0.0, centerY = 0.0, angle = 0) {
    let vertexData = [];
    for (let i = 0; i < n; i++) {
